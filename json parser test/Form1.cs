    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                for (int j = 0; j < 3; j++)
                {
                    object obj = System.Text.Json.JsonSerializer.Deserialize<object>(data);
                    obj = null;
                }
                ts2 = DateTime.Now - dt;
                GC.Collect();
                ...
                Console.WriteLine($"3) JsonParser: {ts1.TotalMilliseconds: 0.000}ms System.Text.Json: {ts2.TotalMilliseconds: 0.000}ms");
            }
            for (int i = 0; i < 5; i++)
            {
                DateTime dt = DateTime.Now;
                ...
                ts2 = DateTime.Now - dt;
                GC.Collect();
                Console.WriteLine($"4) JsonParser: {ts1.TotalMilliseconds: 0.000}ms System.Text.Json: {ts2.TotalMilliseconds: 0.000}ms");
            }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                Console.WriteLine($"5) JsonParser: {ts1.TotalMilliseconds: 0.000}ms");
            }
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                Console.WriteLine($"5) Json.Net: {ts1.TotalMilliseconds: 0.000}ms");
            }
        }
    }
}